...
String getChangelogString() {
  return """
    ...
    When tapping support, planify Pro options highlight
    ...
    < 3.8.0
    planify pro background now extends past scrollable area - support for (i) over-scroll
    ...
    < 3.7.5
    planify Pro banner in settings
