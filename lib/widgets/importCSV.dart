...
import 'package:planify/struct/commonDateFormats.dart';
        ...
        PopupFramework(
          ...
          outsideExtraWidget: appStateSettings["showFAQAndHelpLink"] == true
              ? OutsideExtraWidgetIconButton(
                  ...
                  onPressed: () => openUrl(
                      "https://planifyapp.web.app/faq.html#import-csv-data"),
                )
              : null,
...
Future saveSampleCSV({required BuildContext boxContext}) async {
  await openLoadingPopupTryCatch(() async {
    ...
    String fileName = "planify-import-template" +
